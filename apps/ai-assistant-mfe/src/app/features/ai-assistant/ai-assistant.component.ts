...
import { UsersWidget } from "./users-widget/users-widget.component";
import { DocumentWidget } from "./document-widget/document-widget.component";
...
export { AiAssistant as AiAssistantComponent };
