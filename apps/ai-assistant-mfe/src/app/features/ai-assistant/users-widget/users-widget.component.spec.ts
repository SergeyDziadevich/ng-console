...
import { UsersWidget } from "./users-widget.component";
...
describe('UsersWidget', () => {
  ...
  describe('parseUsers', () => {
    it('should parse valid user line format', () => {
      fixture.componentRef.setInput('text', '* **John Doe** (johndoe) - admin');
    ...
    it('should parse valid user line without role, defaulting to user', () => {
      fixture.componentRef.setInput('text', '* **Alice** (alice123)');
      component.parseUsers();
      expect(component.users).toEqual([
    ...
    it('should parse details containing commas and extract role', () => {
      fixture.componentRef.setInput('text', '* **Bob Smith** (bobsmith, email: bob@example.com, Role: moderator)');
      component.parseUsers();
      expect(component.users).toEqual([
    ...
    it('should parse multiple users', () => {
      fixture.componentRef.setInput('text', '* **User One** (user1)\n* **User Two** (user2) - admin');
      component.parseUsers();
    ...
    it('should ignore invalid lines', () => {
      fixture.componentRef.setInput('text', 'Here are the users:\n* Invalid line format\n* **Valid User** (valid)');
      component.parseUsers();
