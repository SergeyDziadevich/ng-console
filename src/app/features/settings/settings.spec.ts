...
describe('Settings', () => {
  ...
  beforeEach(async () => {
    ...
    mockUserService = {
      getUserById: vi.fn().mockReturnValue(of({ settings: { receiveNotifications: true, receiveEmails: false, receiveSMS: true } })),
  ...
  it('should toggle setting and update user successfully', () => {
    ...
    expect(mockUserService.updateUser).toHaveBeenCalledWith('1', { settings: { receiveNotifications: false } });
